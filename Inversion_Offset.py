...
try:
    os.mkdir(f'/home/rltam/Documents/RunOutputFiles/{folder}/Inversion{iteration}_offset')
    dest_folder = f'/home/rltam/Documents/RunOutputFiles/{folder}/Inversion{iteration}_offset'
...
G = np.loadtxt(f'GreenFunc/matrix({n_spline},{deg})x{amp}_{iteration}_Offset.txt')
G = G[:-1]
...
if iteration > 0:
    ...
    np.savetxt(f'/home/rltam/Documents/RunOutputFiles/{folder}/Inversion{iteration}_offset/Obs-Rec_Strain.txt', diff_strain)
...
if iteration > 0:
    old_coeffs = np.loadtxt(f'/home/rltam/Documents/RunOutputFiles/{folder}/Inversion{iteration-1}_offset/DerivedCoefficients({n_spline},{deg})x{amp}.txt')
...
for i in range(iteration):
    old_thick = np.loadtxt(f'/home/rltam/Documents/RunOutputFiles/{folder}/Inversion{i}_offset/DerivedThickness({n_spline},{deg})x{amp}.txt')
